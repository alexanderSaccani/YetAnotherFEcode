...
%% prova elemento Thermal
elTh = myMesh.Elements(1).Object;

Te = randn(myMesh.nDOFs,1);

[Ktg,F] = elTh.tangent_stiffness_and_force(Te);




%% prova elemento thermal Neumann
elNeum = myMesh.Elements(810).Object;

[Ktg,F] = elNeum.tangent_stiffness_and_force(Te);



%% Tangent stiff matrix assembly
