function [ r, drdqdd,drdqd,drdq, c0] = thermal_residual_interpolation_mod( q, qd, qdd, t, Assembly, ROMs, pfunt, Fext, array4int,varargin)
...
a = squeeze(array4int(:,:,ii));
V(:,ii) = interp1(xsamples,a,xc,'spline');

end


%% compute the residual with the interpolated basis
...
% nVMs = 5;
% [VMsCold,om] = eigs(V'*K*V, V'*M*V, nVMs, 'SM');
